...
export const b2cPolicies = {
    names: {
        signUpSignIn: "B2C_1_smenup_login",
        resetPassword: "B2C_1_password_reset_v001",
    },
    authorities: {
        signUpSignIn: {
            authority: "https://pixisidptest01.b2clogin.com/pixisidptest01.onmicrosoft.com/B2C_1_smenup_login"
        },
        resetPassword: {
            authority: "https://pixisidptest01.b2clogin.com/pixisidptest01.onmicrosoft.com/B2C_1_password_reset_v001"
        } 
    }
}
// #endregion
...
export const msalConfig: Configuration = {
    auth: {
        clientId: "3e759779-6bf4-49ce-b10f-04f56b349736",
